 ...
 SELECT DISTINCT X.NROEMPRESA, X.SEQPESSOA||' - '||G.NOMERAZAO FORNECEDOR, C.COMPRADOR, X.NUMERONF,
      ...
      B.USUAUTORIZOU USU_AUT, U.NOME NOME_AUTORIZACAO, TO_CHAR(B.DTAAUTORIZOU, 'DD/MM/YYYY HH24:MI') DTA_AUTORIZACAO, X.JUSTIFACEITEPEDIDO
  ...
  FROM CONSINCO.MLF_NOTAFISCAL X INNER JOIN CONSINCO.MLF_NFITEM XI    ON XI.SEQNF = X.SEQNF
                                 ...
                                 LEFT JOIN CONSINCO.GE_USUARIO U ON U.CODUSUARIO = B.USUAUTORIZOU
 ...
 WHERE 1=1
   ...
   GROUP BY X.NROEMPRESA, X.NUMERONF, NOME, TO_CHAR(B.DTAAUTORIZOU, 'DD/MM/YYYY HH24:MI'), X.SEQPESSOA, G.NOMERAZAO, C.COMPRADOR,  USUAUTORIZOU,JUSTIFACEITEPEDIDO
