...
SELECT DISTINCT GP.FANTASIA EMP, P.PROMOCAO, P.SEQPROMOCAO COD_PROMOC, PI.SEQPRODUTO PLU, X.SEQFAMILIA FAMILIA, X.DESCCOMPLETA DESC_PROD,
       ...
       CASE WHEN SYSDATE BETWEEN DTAINICIO AND DTAFIM AND PI.STATUS != 'I'
         THEN 'ATIVA' ELSE 'INATIVA' END STATUS_ATUAL_PROMOC
