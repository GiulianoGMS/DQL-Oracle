SELECT NVL( A.SEQPESSOA, 0) || ' - ' || A.NOMERAZAO PESSOA, A.NROEMPRESA,
       ...
       TO_CHAR(C.DTAVENCIMENTO, 'DD/MM/YYYY') DTA_VENCIMENTO,
       ...
       TO_CHAR(A.VLRJUROS, 'FM999G999G990D90', 'NLS_NUMERIC_CHARACTERS='',.''') VLR_JUROS
...
WHERE A.OBRIGDIREITO = DECODE(:LS1, 'Obrigação','O','Direito','D')
  ...
  AND B.DTAOPERACAO  < C.DTAVENCIMENTO
