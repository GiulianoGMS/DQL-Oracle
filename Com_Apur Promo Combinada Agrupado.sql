SELECT 
    ...
    TO_CHAR(SUM(DI.VLRITEM * DI.QUANTIDADE), 'FM999G999G990D90', 'NLS_NUMERIC_CHARACTERS='',.''') VALOR_TOTAL_BRUTO, 
    TO_CHAR(SUM(DI.VLRDESCONTO * DI.QUANTIDADE), 'FM999G999G990D90', 'NLS_NUMERIC_CHARACTERS='',.''') TOTAL_DESCONTO, 
    TO_CHAR(SUM((DI.VLRITEM - DI.VLRDESCONTO) * DI.QUANTIDADE), 'FM999G999G990D90', 'NLS_NUMERIC_CHARACTERS='',.''') VALOR_TOTAL_COM_DESC,
...
SELECT 
    ...
    TO_CHAR(P.DTAINICIO, 'DD/MM/YYYY') DTAINICIO,
    TO_CHAR(P.DTAFIM, 'DD/MM/YYYY') DTAFIM, 
    NULL PLU, NULL EAN, NULL DESC_PROD,
    TO_CHAR(SUM(DI.VLRITEM * DI.QUANTIDADE), 'FM999G999G990D90', 'NLS_NUMERIC_CHARACTERS='',.''') VALOR_TOTAL_BRUTO, 
    TO_CHAR(SUM(DI.VLRDESCONTO * DI.QUANTIDADE), 'FM999G999G990D90', 'NLS_NUMERIC_CHARACTERS='',.''') TOTAL_DESCONTO, 
    TO_CHAR(SUM((DI.VLRITEM - DI.VLRDESCONTO) * DI.QUANTIDADE), 'FM999G999G990D90', 'NLS_NUMERIC_CHARACTERS='',.''') VALOR_TOTAL_COM_DESC,
    SUM(DI.QUANTIDADE) QUANTIDADE_TOTAL
...
GROUP BY 
    P.SEQPROMOCPDV, P.DESCRICAO, P.DTAINICIO, P.DTAFIM
