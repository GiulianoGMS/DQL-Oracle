SELECT DISTINCT X.NROEMPRESA, X.NUMERONF, G.SEQPESSOA||' - '||G.NOMERAZAO FORNECEDOR, X.CODGERALOPER CGO,
       ...
       CASE WHEN NVL(NVL(T.M000_DS_PEDIDO, I.M014_NR_PED_COMP),0) = '0' 
        THEN 'SEM PED XML' ELSE 'SIM' END PED_XML, NVL(T.M000_DS_PEDIDO, I.M014_NR_PED_COMP) PED_XML_NRO,
       CASE WHEN PED.NROPEDIDOSUPRIM IS NULL THEN 'SEM PED C5' ELSE 'SIM' END PED_C5, PED.NROPEDIDOSUPRIM PED_C5_NRO,
       ...
       CASE WHEN NVL(T.M000_DS_PEDIDO, I.M014_NR_PED_COMP) LIKE '%'||PED.NROPEDIDOSUPRIM||'%' THEN 'Pedido XML = C5' ELSE 'Pedido XML Divergente' END COMP_PED
