...
SELECT DISTINCT SEQPRODUTO PLU, DESCCOMPLETA DESCRICAO, C.VLRANTERIOR COD_ORIGEM_ANTERIOR, NVL(C.VLRATUAL,B.CODORIGEMTRIB) COD_ORIGEM_ATUAL, TO_CHAR(C.DTAAUDITORIA, 'DD/MM/YYYY') DTA_AUTERACAO
