SELECT * FROM (
SELECT DISTINCT E.NROEMPRESA EMP, E.SEQPRODUTO PLU, QP.PRODUTO DESCRICAO, NVL(SUM(QTDOPERACAO),0) QTD_VENDA, 
       NVL(E.QTDESTQLOJA,0) EST_LOJA,
       NVL(E.QTDESTQDEPOSITO,0) EST_DEPOSITO,
       NVL(E.QTDESTQTROCA,0) EST_TROCA,
       NVL(E.QTDESTQOUTRO,0) EST_OUTROS, 
...
GROUP BY E.NROEMPRESA, E.SEQPRODUTO, QP.PRODUTO, COMPRADOR_CADASTRO, QTDESTQLOJA, QTDESTQDEPOSITO,QTDESTQTROCA, QTDESTQOUTRO, Y.MARCA, FORNECEDOR_PRINCIPAL,CATEGORIAN3
ORDER BY 2,1
) WHERE STATUS_COMPRA = 'SUSPENSO'
