...
SELECT X.SEQGERCOMPRA LOTE, TO_CHAR(X.DTAHORINCLUSAO, 'DD/MM/YYYY HH24:MI') DTAINCLUSAO, X.USUINCLUSAO, TO_CHAR(DTAGERPEDIDO, 'DD/MM/YYYY') DTAGERPEDIDO, USUGERPEDIDO,
