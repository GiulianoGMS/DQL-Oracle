SELECT TIPO SITUACAO, SEQFAMILIA, FAMILIA DESCRICAO, CODORIGEMTRIB, NROTRIBUTACAO, TRIBUTACAO FROM (

SELECT '1' COD, 'IMP com origem NAC' TIPO, A.SEQFAMILIA, MA.FAMILIA, A.CODORIGEMTRIB, A.NROTRIBUTACAO, B.TRIBUTACAO
