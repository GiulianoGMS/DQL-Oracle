...
SELECT 'ORCAMENTO', NULL ,NULL, NULL, 'TOTAL NFS DESP NACIONAIS', NULL, NULL,
 ...
 (SELECT NUMERONF
  FROM MLF_NOTAFISCAL AA
 WHERE AA.NRODECLARAIMPORT =
       (SELECT NUMERODI
          FROM MAD_PIPROCIMPORTACAO PD
         WHERE PD.NROPROCIMPORTACAO = 62124)
           AND AA.CODGERALOPER = 43)
           
   AND NROEMPRESA = 503 AND X.SITUACAO != 'C'
