 SELECT A.NROEMPRESA,
          ...
          A.NUMERONF,
          C.SEQPESSOA||' - '||C.NOMERAZAO FORNEC,
          DECODE(MF.TIPFORNECEDOR, 'D','Distribuidor','I','Industria','P','Prestador de Serviços') TIPO_FORNEC,
          B.SEQPRODUTO,
          B.QUANTIDADE, 
          D.DESCCOMPLETA,
    ...
    FROM CONSINCO.MLF_NOTAFISCAL A INNER JOIN CONSINCO.TMP_M000_NF K ON K.M000_NR_CHAVE_ACESSO = A.NFECHAVEACESSO
                                   ...
                                   INNER JOIN CONSINCO.MAP_PRODCODIGO PC ON PC.SEQPRODUTO = B.SEQPRODUTO AND PC.TIPCODIGO = 'F'
                                   INNER JOIN CONSINCO.TMP_M014_ITEM L ON L.M000_ID_NF = K.M000_ID_NF AND L.M014_CD_PRODUTO = PC.CODACESSO
                                   ...
                                   INNER JOIN CONSINCO.MAF_FORNECEDOR MF ON MF.SEQFORNECEDOR = C.SEQPESSOA 
 WHERE 1=1
