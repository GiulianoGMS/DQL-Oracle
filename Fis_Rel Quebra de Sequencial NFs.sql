...
SELECT CASE WHEN LENGTH('#LS1') > 10 THEN 'Todas' ELSE '#LS1' END  NROEMPRESA, NULL SERIE, 'Sem Furos!' NF_FALTANTE
 ...
 -- Tira se foi inutilizada;
  AND NOT EXISTS (SELECT 2 FROM MLF_NFINUTILIZACAO I WHERE I.NROEMPRESA = X.LOJA AND I.NRINICIALNF = NF_FALTANTE AND I.SERIENF = X.SERIE)
