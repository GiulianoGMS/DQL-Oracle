...
SELECT * FROM MRL_PRODEMPSEG I WHERE I.NROEMPRESA = 54 AND I.NROSEGMENTO = 7 AND  PRECOBASENORMAL != 0 AND SEQPRODUTO IN (
SELECT SEQPRODUTO FROM MRL_PRODEMPSEG J WHERE J.NROEMPRESA = 54 AND J.NROSEGMENTO = 7 AND STATUSVENDA = 'A' AND J.QTDEMBALAGEM > 1)
