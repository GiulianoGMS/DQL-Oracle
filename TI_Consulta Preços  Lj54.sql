...
SELECT SEQPRODUTO
 ...
 WHERE A.NROEMPRESA = 54 AND A.NROSEGMENTO = 7 AND A.QTDEMBALAGEM > 1 AND (B.PRECOBASENORMAL / B.QTDEMBALAGEM) = A.PRECOBASENORMAL AND STATUSVENDA = 'A'))
...
SELECT MA.DESCCOMPLETA, L.* FROM MRL_PRODEMPSEG L LEFT JOIN MAP_PRODUTO MA ON L.SEQPRODUTO = MA.SEQPRODUTO
