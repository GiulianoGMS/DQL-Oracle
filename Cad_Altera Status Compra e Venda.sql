...
UPDATE MRL_PRODEMPSEG G
          ...
          AND NOT EXISTS (SELECT 1 FROM MAX_EMPRESASEG Z WHERE Z.NROEMPRESA = G.NROEMPRESA AND Z.NROSEGMENTO = G.NROSEGMENTO AND Z.STATUS = 'I');
...
SELECT * FROM CONSINCO.MAX_EMPRESASEG Z WHERE  Z.STATUS = 'I'
