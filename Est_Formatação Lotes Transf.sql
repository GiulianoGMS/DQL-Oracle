...
SELECT '0000000'||LPAD(PC.CODACESSO,13,0)||REPLACE(LPAD(
  ...
  FROM CONSINCO.MRLV_INVRELDIVERG A INNER JOIN (SELECT PCC.SEQPRODUTO, PCC.CODACESSO, ROW_NUMBER() OVER(PARTITION BY PCC.SEQPRODUTO ORDER BY PCC.SEQPRODUTO) ODR FROM
