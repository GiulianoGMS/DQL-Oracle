...
SELECT LA.NROEMPRESA EMP_CTB, TO_CHAR(LA.DTALANCTO, 'DD/MM/YYYY') DATA,
       LA.TIPOLANCTO TP,
       CASE WHEN LA.CODOPERACAO = 452 THEN 11100200101 ELSE CASE WHEN LA.TIPOLANCTO IN ('D') THEN DB.CONTADB ELSE DB.CONTACR END END PARTIDA,  
       CASE WHEN LA.CODOPERACAO = 452 THEN 11200100004 ELSE CASE WHEN LA.TIPOLANCTO IN ('D', 'H') THEN 
         CASE WHEN LA.TIPOLANCTO = 'H' THEN DB.CONTADB ELSE NVL(DC.CONTACR, DT.CONTACR) END ELSE NVL(DC.CONTADB, DT.CONTADB) END END
