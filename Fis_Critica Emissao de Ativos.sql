...
SELECT X.NROPEDVENDA, X.NROEMPRESA,  'CGO correto nesta operação: '||NAGF_BUSCAULTENT_ATIVO(X.NROEMPRESA, XI.SEQPRODUTO) CRITICA
 ...
 WHERE 1=1
   ...
   AND X.NROEMPRESA < 500 -- Retira CDS - Solic Neides
